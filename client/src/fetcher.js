...
const getAllMovies = async (
  ...
  var res = await fetch(
    `http://${config.server_host}:${config.server_port}/movieList?page=${page}&pagesize=${pagesize}&title=${title}&startYearLow=${startYearLow}&startYearHigh=${startYearHigh}&RatingLow=${RatingLow}&RatingHigh=${RatingHigh}`,
    {
      method: 'GET',
    }
  );
